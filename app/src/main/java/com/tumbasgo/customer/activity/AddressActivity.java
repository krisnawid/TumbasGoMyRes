...
import com.tumbasgo.customer.model.Area;
import com.tumbasgo.customer.model.AreaD;
import com.tumbasgo.customer.model.CCode;
import com.tumbasgo.customer.model.UpdateAddress;
...
public class AddressActivity extends BaseActivity implements GetResult.MyListener {
    ...
    public boolean validation() {
        ...
        if (edHoousno.getText().toString().isEmpty()) {
            edHoousno.setError("Masukan Alamat");
            return false;
        }
        if (edSociety.getText().toString().isEmpty()) {
            edSociety.setError("Masukan Kecamatan");
            return false;
        }
        if (edLandmark.getText().toString().isEmpty()) {
            edLandmark.setError("Masukan Keterangan");
            return false;
        }
        if (edPinno.getText().toString().isEmpty()) {
            edPinno.setError("Masukan Nomor Telepon");
            return false;
        }
        return true;
    }
