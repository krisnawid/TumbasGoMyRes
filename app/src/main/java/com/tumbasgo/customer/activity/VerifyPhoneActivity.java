...
public class VerifyPhoneActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMob.setText("Kode OTP telah dikirimkan pada nomor berikut " + phonecode + " " + phonenumber);
        try {
            new CountDownTimer(90000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) {
                    long seconds = TimeUnit.MILLISECONDS.toSeconds(millisUntilFinished);
                    btnTimer.setText(seconds + " Detik");
                }
