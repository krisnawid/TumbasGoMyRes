...
import com.tumbasgo.customer.fragment.Info1Fragment;
import com.tumbasgo.customer.fragment.Info2Fragment;
import com.tumbasgo.customer.fragment.Info3Fragment;
        ...
        switch (view.getId()) {
            case R.id.btn_next:
                if (selectPage == 0) {
                    ...
                    sessionManager.setBooleanData(SessionManager.isopen, true);
                    User user = new User();
                    user.setId("0");
                    user.setName("User");
